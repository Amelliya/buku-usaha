                        ...
                        <form method="POST" action="<?= base_url(); ?>/produk/tambah_produk">
                            ...
                            <div class=" form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control uang" id="harga_beli1" name="harga_beli1" autocomplete="off" placeholder="Masukan Harga Beli Produk..." value="<?= set_value('harga_beli');  ?>">
                                    <?= form_error('harga_beli', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class=" form-group col-md-6">
                                    <label for="harga_jual">Harga Jual Produk (Rp)</label>
                                    <input type="text" class="form-control uang" id="harga_jual1" name="harga_jual1" autocomplete="off" placeholder="Masukan Harga Jual Produk..." value="<?= set_value('harga_jual');  ?>">
